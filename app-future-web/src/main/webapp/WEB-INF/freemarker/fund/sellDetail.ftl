...
<section class="bg-gray">
  ...
  <ul class="list-group col-2 ft-list">
    ...
    <li class="list-group-row"><span class="list-group-item">业务类型：</span><span class="list-group-item">赎回</span></li>
    ...
    <li class="list-group-row"><span class="list-group-item">申请份额：</span><span class="list-group-item"><code>${entrust.wtfe!nullShow}份</code></span></li>
    <li class="list-group-row"><span class="list-group-item">确认金额：</span><span class="list-group-item"><#if entrust.wtzt==0>--<#else>${(entrust.cjje!nullShow)?string('#,##0.00')}</#if>元</span></li>
...
<!-- <li class="list-group-row"><span class="list-group-item">关联银行：</span><span class="list-group-item">中国建设银行（尾号9335）</span></li>  -->
	<#if capitalBackDate??>
		<li class="list-group-row"><span class="list-group-item">资金状态：</span>
			<span class="list-group-item">预计${capitalBackDate!nullShow}个交易日到账</span>
		</li>
	</#if>
